...
st.text('・飲み込んだ場合：ただちに医師に連絡すること。口をすすぐこと。')
st.text('・眼に入った場合：水で数分間注意深く洗うこと。コンタクトレンズを使用していて容易に外せる場合は外すこと。その後も洗浄を続けること。ただちに医師に連絡すること。')
st.text('・皮膚等に付着した場合：ただちに汚染された衣類を全て脱ぐこと。皮膚を多量の水と石けんで洗うこと。皮膚刺激が生じた場合、医師の手当てを受けること。')
